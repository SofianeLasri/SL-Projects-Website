...
<div class="navbar">
    <div class="desktop top-bar">
        ...
        <div class="right-part">
            <form class="search" type="get">
                <button class="btn btn-link text-white" type="submit" title="{{ __('general/verb.to_search') }}"><i
    ...
    <div class="mobile">
        <div class="top-bar container">
            <button class="btn btn-link text-white" id="openMobileMenu" type="button" title="{{ __('general/verbal.open-menu') }}"><i
                    class="fa-solid fa-bars"></i>
            </button>
            <a href="{{ route('showcase.home') }}">
                <img src="{{ Vite::asset('resources/images/logos/white-short.svg') }}" alt="Logo">
            </a>
            <button class="btn btn-link text-white" id="focusMobileSearchBar" type="button" title="{{ __('general/verb.to_search') }}">
                <i
